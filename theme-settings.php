 ...
 */
function cfu_theme_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['cfu_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cfu_theme sample setting'),
  '#default_value' => theme_get_setting('cfu_theme_example'),
